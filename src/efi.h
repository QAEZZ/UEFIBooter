...
// Industry Standard Configuration Tables: UEFI Spec 2.10 Sect 4.6.1.1
...
#define EFI_SIMPLE_POINTER_PROTOCOL_GUID                                       \
  {                                                                            \
    0x31878c87, 0xb75, 0x11d5, 0x9a, 0x4f,                                     \
    {                                                                          \
...
#define EFI_ABSOLUTE_POINTER_PROTOCOL_GUID                                     \
  {                                                                            \
    0x8D59D32B, 0xC655, 0x4AE9, 0x9B, 0x15,                                    \
    {                                                                          \
...
#define EFI_LOADED_IMAGE_PROTOCOL_GUID                                         \
  {                                                                            \
    0x5B1B31A1, 0x9562, 0x11d2, 0x8E, 0x3F,                                    \
    {                                                                          \
...
#define EFI_BLOCK_IO_PROTOCOL_GUID                                             \
  {                                                                            \
    0x964e5b21, 0x6459, 0x11d2, 0x8e, 0x39,                                    \
    {                                                                          \
      0x00, 0xa0, 0xc9, 0x69, 0x72, 0x3b                                       \
    }                                                                          \
  }
...
#define EFI_PARTITION_INFO_PROTOCOL_GUID                                       \
  {                                                                            \
    0x8cf2f62c, 0xbc9b, 0x4821, 0x80, 0x8d,                                    \
    {                                                                          \
...
// PCI Root Bridge I/O Protocol: UEFI Spec 2.10 Sect 14.2.1
...
typedef struct
{
  ...
  BOOLEAN
  SetsToZero; // TRUE = time set clears the time below the resolution level
} EFI_TIME_CAPABILITIES;
...
typedef EFI_STATUS(EFIAPI* EFI_BLOCK_RESET)(IN EFI_BLOCK_IO_PROTOCOL* This,
                                            IN BOOLEAN ExtendedVerification);

// EFI_BLOCK_READ: UEFI Spec 2.10 section 13.9.3
typedef EFI_STATUS(EFIAPI* EFI_BLOCK_READ)(IN EFI_BLOCK_IO_PROTOCOL* This,
                                           IN UINT32 MediaId,
                                           IN EFI_LBA LBA,
                                           IN UINTN BufferSize,
                                           OUT VOID* Buffer);
...
typedef EFI_STATUS(EFIAPI* EFI_BLOCK_WRITE)(IN EFI_BLOCK_IO_PROTOCOL* This,
                                            IN UINT32 MediaId,
                                            IN EFI_LBA LBA,
                                            IN UINTN BufferSize,
                                            IN VOID* Buffer);
...
typedef EFI_STATUS(EFIAPI* EFI_DISK_READ)(IN EFI_DISK_IO_PROTOCOL* This,
                                          IN UINT32 MediaId,
                                          IN UINT64 Offset,
                                          IN UINTN BufferSize,
                                          OUT VOID* Buffer);
...
typedef EFI_STATUS(EFIAPI* EFI_DISK_WRITE)(IN EFI_DISK_IO_PROTOCOL* This,
                                           IN UINT32 MediaId,
                                           IN UINT64 Offset,
                                           IN UINTN BufferSize,
                                           IN VOID* Buffer);
...
// EFI_CONFIGURATION_TABLE: UEFI Spec 2.10 Sect 4.6.1
typedef struct
{
  EFI_GUID VendorGuid;
  VOID* VendorTable;
...
// Protocol Interface Structure: UEFI Spec 2.10 Sect 14.2.1
...
//  EFI_PCI_ROOT_BRIDGE_IO_PROTOCOL.Map(): UEFI Spec 2.10 Sect 14.2.11
...
// EFI_PCI_ROOT_BRIDGE_IO_PROTOCOL_UNMAP(): UEFI Spec 2.10 Sect 14.2.12
typedef EFI_STATUS(EFIAPI* EFI_PCI_ROOT_BRIDGE_IO_PROTOCOL_UNMAP)(
  IN EFI_PCI_ROOT_BRIDGE_IO_PROTOCOL* This,
  IN VOID* Mapping);

// EFI_PCI_ROOT_BRIDGE_IO_PROTOCOL.AllocateBuffer(): UEFI Spec 2.10 Sect 14.2.13
...
// EFI_PCI_ROOT_BRIDGE_IO_PROTOCOL.FreeBuffer(): UEFI Spec 2.10 Sect 14.2.14
typedef EFI_STATUS(EFIAPI* EFI_PCI_ROOT_BRIDGE_IO_PROTOCOL_FREE_BUFFER)(
  IN EFI_PCI_ROOT_BRIDGE_IO_PROTOCOL* This,
  IN UINTN Pages,
  IN VOID* HostAddress);

// EFI_PCI_ROOT_BRIDGE_IO_PROTOCOL.Flush(): UEFI Spec 2.10 Sect 14.2.15
typedef EFI_STATUS(EFIAPI* EFI_PCI_ROOT_BRIDGE_IO_PROTOCOL_FLUSH)(
  IN EFI_PCI_ROOT_BRIDGE_IO_PROTOCOL* This);

// EFI_PCI_ROOT_BRIDGE_IO_PROTOCOL.GetAttributes(): UEFI Spec 2.10 Sect 14.2.16
typedef EFI_STATUS(EFIAPI* EFI_PCI_ROOT_BRIDGE_IO_PROTOCOL_GET_ATTRIBUTES)(
  IN EFI_PCI_ROOT_BRIDGE_IO_PROTOCOL* This,
  OUT UINT64* Supports OPTIONAL,
  OUT UINT64* Attributes OPTIONAL);

// EFI_PCI_ROOT_BRIDGE_IO_PROTOCOL.SetAttributes(): UEFI Spec 2.10 Sect 14.2.17
...
// EFI_PCI_ROOT_BRIDGE_IO_PROTOCOL.Configuration(): UEFI Spec 2.10 Spec 14.2.18
